...
function CyberCore() {
    ...
    return (
        <Float speed={2} rotationIntensity={0.5} floatIntensity={1}>
            ...
            <NeonRing radius={2.6} thickness={0.02} speed={0.4} color="#00B4E5" rotationOffsets={[Math.PI / 6, 0, 0]} />
            <NeonRing radius={3.1} thickness={0.015} speed={-0.25} color="#33C6EA" rotationOffsets={[0, Math.PI / 3, 0]} />
            <NeonRing radius={3.6} thickness={0.01} speed={0.15} color="#00B4E5" rotationOffsets={[Math.PI / 3, Math.PI / 4, 0]} />
        </Float>
    );
}
        ...
        <div style={{ width: '100%', height: '100%', pointerEvents: 'auto' }}>
            <Canvas camera={{ position: [0, 0, 15], fov: 45 }} dpr={[1, 2]}>
                <Suspense fallback={null}>
                    ...
                    <directionalLight position={[-10, -10, -5]} intensity={1} color="#00B4E5" />
                    ...
                    <Sparkles count={100} scale={10} size={2} speed={0.6} opacity={0.8} color="#00B4E5" />
                    <Sparkles count={50} scale={12} size={4} speed={0.4} opacity={0.5} color="#33C6EA" />
